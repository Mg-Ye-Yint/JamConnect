      ...
      <div className="min-h-screen bg-gray-100 flex flex-col">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-grow">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-base sm:text-lg lg:text-xl leading-relaxed text-gray-700 mb-6">
              Our mission is to create a vibrant community where musicians of
              all skill levels can come together to share ideas, create music,
              and inspire one another. We believe that every musician deserves
              the chance to find the perfect musical match, and MusicianHub is
