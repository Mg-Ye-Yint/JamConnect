...
const LoginRequest = () => {
  ...
  return (
    <div className="fixed inset-0 flex bg-black bg-opacity-50 justify-center items-center z-20">
      <div className="relative flex flex-row  bg-slate-400 justify-center items-center  w-[250px] md:w-[350px] lg:w-[500px] h-[150px] z-30 rounded-md shadow-lg shadow-gray-700/50">
        <button
