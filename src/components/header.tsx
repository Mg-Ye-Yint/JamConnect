...
function Header() {
  ...
  return (
    <div className="flex flex-row items-center justify-between w-full p-4 border-b-2 bg-zinc-300">
      ...
      <div className=" flex items-center gap-4">
        <div className="flex flex-col md:flex-row gap-2 items-center">
          <Image
            ...
            height={100}
          />
          <button className="flex flex-col justify-center bg-violet-700 rounded-md items-center p-2 hover:bg-violet-600 cursor-pointer md:h-[68px] md:w-[78px] lg:w-[150px] lg:h-[68px]">
          ...
          {session ? (
            <button
              className=" bg-green-700 rounded-md items-center p-2 hover:bg-green-600 cursor-pointer w-full md:h-[68px] md:w-[78px] lg:w-[150px] lg:h-[68px]"
              onClick={() => {
                signOut();
              }}
            >
